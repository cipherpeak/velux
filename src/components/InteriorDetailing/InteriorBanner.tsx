...
const bannerData = {
  ...
  description: "Restore your vehicle's interior to like-new condition with our comprehensive interior detailing services. From basic cleaning to complete restoration.",
}
            ...
            <div className="max-w-2xl xl:max-w-5xl w-full bg-white/5 backdrop-blur-sm shadow-2xl border border-white/20 p-6 rounded-4xl">
              <div className="space-y-4 md:space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-3 pt-4">
                  <button className="px-8 py-4 bg-secondary text-black rounded-xl font-medium transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-sebg-secondary/25 flex items-center gap-2 justify-center hover:scale-105 transform">
                    Get Interior Quote
                    <Wand2 className="w-4 h-4" />
                  </button>
                  <button className="px-8 py-4 border border-secondary text-violet-100 rounded-xl font-medium transition-all duration-300  backdrop-blur-sm flex items-center gap-2 justify-center">
                    View Results
