...
const bannerData = {
  title: "Professional Window",
  subtitle: "Premium Protection",
  description: "Enhance your vehicle's style, comfort, and protection with our professional automotive window tinting services.",
}

function WindoTintingBanner() {
  return (
...
export default WindoTintingBanner