  ...
  return (
    ...
    >
      <AnimatePresence initial={false}>
        ...
        >
          <div className="w-36 h-full [mask-image:radial-gradient(100px_at_left,white,transparent)] absolute top-1/2 -translate-y-1/2 left-0 bg-gradient-to-r from-secondary via-transparent to-transparent z-20 opacity-50" />
